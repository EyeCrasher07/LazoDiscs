...
This source package targets Minecraft 1.21.11 / NeoForge 21.3.x.

Use Plasmo Voice for NeoForge 1.21.11 on both client and server.


## Minecraft 1.21.11 port

This source package targets Minecraft 1.21.11 / NeoForge 21.4.x.
...
This source package targets Minecraft 1.21.11 / NeoForge 21.5.x.
...
This source package targets Minecraft 1.21.11 / NeoForge 21.6.x.
...
This source package targets Minecraft 1.21.11 / NeoForge 21.7.x.
...
This source package targets Minecraft 1.21.11 / NeoForge 21.8.x.

Use Plasmo Voice for NeoForge 1.21.11–1.21.8 on both client and server.


## Minecraft 1.21.11 port

This source package targets Minecraft 1.21.11 / NeoForge 21.9.x.
...
This source package targets Minecraft 1.21.11 / NeoForge 21.10.x.

Use Plasmo Voice for NeoForge 1.21.11–1.21.10 on both client and server.


## Minecraft 1.21.11 port

This source package targets Minecraft 1.21.11 / NeoForge 21.11.x.

Use Plasmo Voice for NeoForge 1.21.11 on both client and server.

Parchment is disabled for this port.
